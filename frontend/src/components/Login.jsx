  ...
  return (
    <Box sx={boxStyle1}>
      ...
      <Box sx={boxStyle2}>
        ...
        <TextField variant='filled' onChange={(e)=>{setEmail(e.target.value)}} name='email' required label="Email" type='text' fullWidth style={inputStyle}/>
        <TextField variant='filled' onChange={(e)=>{setPassword(e.target.value)}} name='password' required label="Password" type="password" fullWidth style={inputStyle} />
