    ...
    <>
      ...
      <Stack direction="row">
          ...
          >
            <CardContent>
              ...
              <Stack direction="row" style={{ marginTop: "3vh" }} spacing={2}>
                ...
                <Typography variant="body2" color="text.secondary">
                  • Ends on :{new Date(job.deadline).toLocaleString()}
                </Typography>
              </Stack>
        ...
        <Container style={containerStyle2}>
          ...
          <Typography
            variant="h6"
            style={{ fontFamily: "fantasy", marginBottom: "10px" }}
            color="initial"
          >
            About the client
          </Typography>
          ...
          >
            <Avatar>
              {job.postedBy.firstName ? job.postedBy.firstName.charAt(0) : "C"}
            </Avatar>
            <Typography variant="body1">
              {" "}
              {job.postedBy.firstName || "Unknown Client"}{" "}
          ...
          <Stack direction="row" alignItems="center" spacing={1}>
            ...
            <Typography variant="body2" color="text.secondary">
              {" "}
              {job.postedBy.address || "Location not provided"}{" "}
            </Typography>
          </Stack>
          ...
          <Stack direction="column" spacing={1} style={{ marginTop: "20px" }}>
            ...
            <Stack direction="row" spacing={1}>
              ...
              <Typography variant="body2" color="text.secondary">
                {" "}
                {job.postedBy.socialMedia.github || "NA"}{" "}
              </Typography>
            </Stack>
          </Stack>
        </Container>
