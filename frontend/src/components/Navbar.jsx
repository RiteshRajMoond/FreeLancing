...
export default function Navbar() {
    const btnStyle = {marginRight:"20px", padding:"0.3rem 1.4rem", backgroundColor: "transparent", color:"white", borderRadius:"40px", fontFamily:"fantasy"};
    const toolStyle = {padding:"0.3rem 1.4rem"};
    const barStyle = {padding:"0.3rem 1.4rem", backgroundColor:"black", border:"1px red"   };
